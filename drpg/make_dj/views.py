...
def view(request, project_id):
    contents = urllib.request.urlopen("http://" + project_id).read()
    # This redirects through a proxy to the user's project
    return contents

@csrf_exempt 
def view_redir(request, project_id):
    resp = urllib.request.urlopen('file:///app/index.html')
